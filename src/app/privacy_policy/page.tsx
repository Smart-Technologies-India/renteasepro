      ...
      <div className="bg-white p-8 shadow rounded-md w-full mt-3">
        <section className="mb-8">
          <p className="text-lg mt-2">
            ...
            https://pdadnhrent.com, or the PDA DNH rent Web Application
            application (collectively, “PDA DNH Rent Platform”) made available
            by Planning and Development Authority ,DNH (“PDA DNH”, “Company”,
            “we”, “us” and “our”), a Government establishment established under
            the laws of India having its registered office at “A” Wing ,Second
            Floor,District Secretariat,Silvassa-396230.
          </p>
          <p className="text-lg mt-2">
            The terms “you” and “your” refer to the user of the PDA DNH Rent
            Platform. The term “Services” refers to any services offered by PDA
            DNH whether on the PDA DNH Rent Platform or otherwise.
          </p>
          <p className="text-lg mt-2">
            Please read this Policy before using the PDA DNH Rent Platform or
            submitting any personal information to PDA DNH. This Policy is a
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            By using the PDA DNH Rent Platform and the Services, you agree and
            ...
            please do not use or access the PDA DNH Rent Platform.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            such changes, such as via prominent notice on the PDA DNH Rent
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            models, contact_list, operating systems and versions, software, file
            names and versions, preferred languages, unique device identifiers,
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            Our PDA DNH Rent Platform and third parties with whom we partner,
            may use cookies, mobile device IDs, “flash cookies” and similar
            files or technologies to collect and store information with respect
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            features to personalise your PDA DNH Rent account;
          </p>
          <p className="text-lg mt-2">
          ...
          <p className="text-lg mt-2">
            To administer and enhance the security of our PDA DNH Rent Platform
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            password which enables you to access certain parts of the PDA DNH
            Rent Platform, you are responsible for keeping these details
          ...
          <p className="text-lg mt-2">
            ...
            data transmitted through the PDA DNH Rent Platform. Once we have
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mt-2">
            ...
            to comply with our legal obligations. We may not be able offer you
            any or all Services upon such withdrawal of your consent.
          </p>
          <p className="text-lg mt-2">
            Our payment gateway and payment processing are compliant with the
            payment card industry standard (generally referred to as PCI
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">
            9. GRIEVANCE OFFICER AND PDA DNH Rent PLATFORM SECURITY
          </h2>
          <p className="text-lg mt-2">
            ...
            email us at dabbawala.smart@gmail.com or write to our Grievance
          ...
          <p className="text-lg mt-2">
            ...
            with the cloud platform of Hostinger Web Services provided by
            Hostinger PTE Ltd, which may store this data on their servers
