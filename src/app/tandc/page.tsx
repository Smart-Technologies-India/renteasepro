    ...
    <div className="bg-gray-100 min-h-screen px-6 py-4">
      ...
      <div className="bg-white p-8 shadow rounded-md w-full mt-3">
        <section className="mb-8">
          ...
          <p className="text-lg">
            PDA DNH RENT, operated by the Planning and Development Authority
            (PDA) of Dadra and Nagar Haveli, provides a platform exclusively for
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">
            PDA DNH RENT facilitates the listing and promotion of
            government-owned properties for rental purposes. All property
            listings are subject to approval by PDA DNH and must adhere to
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">
            Rental agreements for PDA-owned properties facilitated through PDA
            DNH RENT are governed by applicable laws and regulations. Users are
            responsible for reviewing and understanding the terms of rental
            agreements before entering into transactions.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">
          ...
          <p className="text-lg">
            ...
            information provided during registration and property listings. PDA
            DNH reserves the right to verify user information and take
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">
            ...
            textual content, displayed on PDA DNH RENT is the property of PDA
            DNH or its licensors and is protected by intellectual property laws.
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">
            PDA DNH RENT strives to provide accurate and reliable information
        ...
        <section className="mb-8">
          ...
          <p className="text-lg">
            ...
            arising from the use of PDA DNH RENT shall be subject to the
            exclusive jurisdiction of the courts in Dadra and Nagar Haveli.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">
          ...
          <p className="text-lg">
            PDA DNH reserves the right to update or modify these Terms and
