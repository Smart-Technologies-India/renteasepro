...
import ActionNeeded from "@/action/report/actionneeded";
    ...
    <>
      <div className="p-6">
        <div className="flex gap-4 items-center">
          ...
          <p className="text-xl text-gray-600">Action Needed</p>
            ...
            <TableBody>
              {bids.map((bid, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>
                    {formateDate(new Date(bid.bid.bidenddate))}
                  </TableCell>
