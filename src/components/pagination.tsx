        ...
        <div className="flex gap-2 items-center">
          <div className="relative">
            <div
              ...
              className="bg-transparent px-2 h-7 text-sm text-black font-normal text-center rounded-md border border-gray-500 hover hover:border-blue-500 flex gap-1 items-center w-32 cursor-pointer"
            >
            ...
            <div
              className={`bg-transparent absolute bottom-0 -translate-y-10 bg-white  left-0 rounded-md shadow-sm w-32 overflow-y-hidden transition-all duration-500 ${
